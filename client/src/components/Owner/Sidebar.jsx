...
const Sidebar = () => {
  ...
  return (
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-[52px] md:max-w-60 w-full border-r border-borderColor text-sm">
          ...
          <img
            src={
              image
                ...
                : user?.image ||
                  "https://images.unsplash.com/photo-1522266925358-423ceac13bc9?auto=format&fit=crop&w=300&q=80"
            }
            alt=""
